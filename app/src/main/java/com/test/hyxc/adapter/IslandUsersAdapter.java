...
import static cn.jpush.im.android.api.jmrtc.JMRTCInternalUse.doCompleteCallBackToUser;
import static cn.jpush.im.android.api.jmrtc.JMRTCInternalUse.getApplicationContext;

public class IslandUsersAdapter extends BaseAdapter implements View.OnClickListener  {
    private LayoutInflater inflater;
    private List<IslandResidentUserInfo> listUserInfo;
    String url="";
    Context context;
    private OnItemClickListener mOnItemClickListener;
    public IslandUsersAdapter(Context context, List<IslandResidentUserInfo> listUserInfo){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            convertView=inflater.inflate(R.layout.imap_island_user_item,parent,false);
        ...
        //如果是普通用户隐藏 操作按钮
        if(!listUserInfo.get(position).getShowMore()){
        ...
        holder.iv_more.setOnClickListener(IslandUsersAdapter.this);
        return  convertView;
    }
