    ...
    protected void initView() {
        ...
        mJCameraView.setSaveVideoPath(
            Environment.getExternalStorageDirectory().getPath() + File.separator
                + "imap" + File.separator + "small_video");
        ...
        mJCameraView.setErrorLisenter(new ErrorListener() {
            ...
            public void AudioPermissionError() {
                Toast.makeText(VideoCameraActivity.this, "请打开录音权限~", Toast.LENGTH_SHORT).show();
            }
        });
        //JCameraView监听
...
//                Log.i("JCameraView", "bitmap = " + bitmap.getWidth());
            ...
            public void recordSuccess(String url, Bitmap firstFrame) {
                ...
                //url:/storage/emulated/0/imap/small_video/video_1508930416375.mp4, Bitmap:/storage/emulated/0/imap/small_video/picture_1508930429832.jpg
                Log.d("CJT", "url:" + url + ", firstFrame:" + path);
                Intent intent =new Intent();
                intent.setClass(VideoCameraActivity.this,TrimVideoActivity.class);
