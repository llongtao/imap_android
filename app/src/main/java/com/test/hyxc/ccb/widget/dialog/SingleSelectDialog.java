package com.test.hyxc.ccb.widget.dialog;
...
import com.test.hyxc.ccb.base.DefaultBaseAdapter;
import com.test.hyxc.ccb.utils.ViewUtils;
/**
 * 单选弹窗
 *
 */
public class SingleSelectDialog extends AppCompatDialog {
    ...
    public static class Builder {
        ...
        private void addItems(CharSequence[] items, OnClickListener listener) {
            ListView listView = (ListView)dialog.findViewById(R.id.lv_single_select);
        ...
        public SingleSelectDialog setHead(CharSequence title) {
            if (null != dialog && !TextUtils.isEmpty(title)) {
                AppCompatTextView textView = (AppCompatTextView)dialog.findViewById(R.id.tvTitle);
