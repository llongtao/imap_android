package com.test.hyxc.transformations;
...
/**
 * Used 基于glide3.7.0版本的圆角功能（可以设置不同方位的圆角）
 ...
 * https://www.jianshu.com/p/a32ce117275b
 */
...
public class RoundCornersTransformation implements Transformation<Bitmap> {
	...
	public RoundCornersTransformation(Context context, int radius, int i, CornerType type) {
