...
public class GridViewAddVideoAdpter extends BaseAdapter  implements View.OnClickListener {
     ...
     * 默认1张
     */
    private int maxVideos = 2;

    public GridViewAddVideoAdpter(List<Map<String, Object>> datas, Context context) {
        this.datas = datas;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.imap_publish_item_published_grida, parent, false);
        ...
        if (datas != null && position < datas.size()) {
            ...
            viewHolder.btdel.setTag(position);
            ...
            Glide.with(context)
                    .load(R.mipmap.imap_publish_video_add)
                    .priority(Priority.HIGH)
                    .centerCrop()
                    .into(viewHolder.ivimage);
