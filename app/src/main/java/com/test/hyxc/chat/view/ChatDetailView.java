...
public class ChatDetailView extends LinearLayout {
    ...
    public void initModule() {
        ...
        goto_inside = (Button) findViewById(R.id.goto_inside);
        iv_group_logo=(ImageView)findViewById(R.id.iv_group_logo);
    ...
    //显示海岛头像 gridview 隐藏
    public void setGridHide(GroupInfo groupInfo){
        mGridView.setVisibility(GONE);
        iv_group_logo.setVisibility(VISIBLE);
        tv_nickname.setVisibility(VISIBLE);
    ...
    public void setListeners(OnClickListener onClickListener) {
        ...
        goto_inside.setOnClickListener(onClickListener);
        iv_group_logo.setOnClickListener(onClickListener);
    }
    ...
    public void setSingleView(boolean friend) {
        ...
        goto_inside.setVisibility(View.VISIBLE);
    }
    /*public void setSingleView(boolean friend) {
        if (friend) {
