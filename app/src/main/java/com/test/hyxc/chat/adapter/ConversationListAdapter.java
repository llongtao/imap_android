...
import com.test.hyxc.chat.utils.ViewHolder;
import com.test.hyxc.chat.view.ConversationListView;
import com.test.hyxc.chat.view.SwipeLayoutConv;
...
//                //会话界面时间
                ...
                switch (lastMsg.getContentType()) {
                    ...
                    case custom:
                        ...
                        if (isBlackListHint != null && isBlackListHint) {
                            ...
                            Map map = customContent.getAllStringValues();
                            if(map.get("share_type")!=null && "work".equals(String.valueOf(map.get("share_type")))){
                                contentStr = mContext.getString(R.string.share_work);
                            }else {
                            ...
                            if(map.get("share_type")!=null && "activity".equals(String.valueOf(map.get("share_type")))){
                                contentStr = mContext.getString(R.string.share_activity);
                            }else{
                                contentStr = mContext.getString(R.string.type_custom);
                            }
                        }
                ...
                if (mAtAll.get(position) && AppContext.isAtall.get(gid) != null && AppContext.isAtall.get(gid)) {
                ...
                } else if (mArray.get(position) && AppContext.isAtMe.get(gid) != null && AppContext.isAtMe.get(gid)) {
                    //有人@我 文字提示
                    ...
                    if (lastMsg.getTargetType() == ConversationType.group && !contentStr.equals("[群成员变动]")) {
                        ...
                        if (AppContext.isAtall.get(gid) != null && AppContext.isAtall.get(gid)) {
                            content.setText("[@所有人] " + fromName + ": " + contentStr);
                        } else if (AppContext.isAtMe.get(gid) != null && AppContext.isAtMe.get(gid)) {
                ...
                mUserInfo.getAvatarBitmap(new GetAvatarBitmapCallback() {
                    ...
                    public void gotResult(int status, String desc, Bitmap bitmap) {
                        if (status == 0) {
                            ...
                            headIcon.setImageResource(R.mipmap.head1);
                        }
                    }
                });
            } else {
