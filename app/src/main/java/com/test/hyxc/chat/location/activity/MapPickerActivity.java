package com.test.hyxc.chat.location.activity;
...
import com.test.hyxc.chat.location.adapter.MapPickerAdapter;
import com.test.hyxc.chat.location.service.LocationService;
...
public class MapPickerActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationService = AppContext.locationService_jiguang;
        ...
        String targetId = getIntent().getStringExtra(AppContext.TARGET_ID);
        String targetAppKey = getIntent().getStringExtra(AppContext.TARGET_APP_KEY);
                ...
                mBaiduMap.snapshotScope(rect, new BaiduMap.SnapshotReadyCallback() {
                    ...
                    public void onSnapshotReady(Bitmap bitmap) {
                        if (null != bitmap && null != conv) {
                            ...
                            setResult(AppContext.RESULT_CODE_SEND_LOCATION, intent);
                            finish();
                        } else {
