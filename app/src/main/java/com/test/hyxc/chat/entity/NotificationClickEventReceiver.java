    ...
    public void onEvent(NotificationClickEvent notificationClickEvent) {
        ...
        if (msg != null) {
            ...
            if (type == ConversationType.single) {
                ...
                notificationIntent.putExtra(AppContext.TARGET_ID, targetId);
                notificationIntent.putExtra(AppContext.TARGET_APP_KEY, appKey);
            } else {
                conv = JMessageClient.getGroupConversation(Long.parseLong(targetId));
                notificationIntent.putExtra(AppContext.GROUP_ID, Long.parseLong(targetId));
            }
            notificationIntent.putExtra(AppContext.CONV_TITLE, conv.getTitle());
