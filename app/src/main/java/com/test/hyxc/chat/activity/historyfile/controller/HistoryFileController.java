package com.test.hyxc.chat.activity.historyfile.controller;
...
import com.test.hyxc.chat.activity.historyfile.fragment.AudioFileFragment;
import com.test.hyxc.chat.activity.historyfile.fragment.DocumentFileFragment;
import com.test.hyxc.chat.activity.historyfile.fragment.ImageFileFragment;
import com.test.hyxc.chat.activity.historyfile.fragment.OtherFileFragment;
import com.test.hyxc.chat.activity.historyfile.fragment.VideoFileFragment;
import com.test.hyxc.chat.activity.historyfile.view.HistoryFileView;
import com.test.hyxc.chat.adapter.ViewPagerAdapter;
import tools.AppContext;
import com.test.hyxc.chat.entity.SelectedHistoryFileListener;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.delete_file_btn:
                ...
                AppContext.ids.clear();
                for (Integer id : idMap.keySet()) {
                    //把即将被删除的消息添加进集合中,注意获取message的id是从map中拿出来的.
                    AppContext.ids.add(conversation.getMessage(idMap.get(id)));
