...
import com.test.hyxc.chat.activity.SendFileActivity;
import com.test.hyxc.chat.activity.fragment.AudioFragment;
import com.test.hyxc.chat.activity.fragment.DocumentFragment;
import com.test.hyxc.chat.activity.fragment.ImageFragment;
import com.test.hyxc.chat.activity.fragment.OtherFragment;
import com.test.hyxc.chat.activity.fragment.VideoFragment;
import com.test.hyxc.chat.adapter.ViewPagerAdapter;
import tools.AppContext;
import com.test.hyxc.chat.entity.FileType;
import com.test.hyxc.chat.entity.UpdateSelectedStateListener;
import com.test.hyxc.chat.utils.BitmapLoader;
import com.test.hyxc.chat.view.SendFileView;
...
public class SendFileController implements View.OnClickListener, ViewPager.OnPageChangeListener,
    ...
    public SendFileController(SendFileActivity context, SendFileView view) {
        ...
        String targetId = mContext.getIntent().getStringExtra(AppContext.TARGET_ID);
        String targetAppKey = mContext.getIntent().getStringExtra(AppContext.TARGET_APP_KEY);
        long groupId = mContext.getIntent().getLongExtra(AppContext.GROUP_ID, 0);
        if (groupId != 0) {
            ...
            if (controller != null) {
                switch (msg.what) {
                    case SEND_FILE:
                        ...
                        intent.putExtra(AppContext.MsgIDs, controller.mMsgIds);
                        controller.mContext.setResult(AppContext.RESULT_CODE_SEND_FILE, intent);
