...
import com.test.hyxc.chat.adapter.StickyListHeadersAdapter;
...
import com.test.hyxc.chat.view.MyImageView;
        ...
        ll_document.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (content.getLocalPath() == null) {
                    ...
                    final String newPath = "sdcard/com.test.hyxc/recvFiles/" + content.getFileName();
