...
import com.test.hyxc.chat.adapter.AllMembersAdapter;
...
import com.test.hyxc.chat.utils.pinyin.HanyuPinyin;
...
//        mSideBar.setTextView(mLetterHintTv);
        ...
        mIsDeleteMode = getIntent().getBooleanExtra(AppContext.DELETE_MODE, false);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.return_btn:
                    ...
                    setResult(AppContext.RESULT_CODE_ALL_MEMBER, intent);
                    finish();
                    break;
                case R.id.right_btn:
                    if (mIsDeleteMode) {
