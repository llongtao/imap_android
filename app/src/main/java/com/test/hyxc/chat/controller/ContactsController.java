...
import com.test.hyxc.chat.activity.FriendRecommendActivity;
import com.test.hyxc.chat.activity.GroupActivity;
        ...
        ContactManager.getFriendList(new GetUserInfoListCallback() {
            ...
            public void gotResult(int responseCode, String responseMessage, List<UserInfo> userInfoList) {
                ...
                if (responseCode == 0) {
                    ...
                    List<FriendEntry> friends = AppContext.getUserEntry().getFriends();
