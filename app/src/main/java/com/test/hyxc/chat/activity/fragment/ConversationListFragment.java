...
import com.test.hyxc.chat.controller.ConversationListController;
import com.test.hyxc.chat.controller.MenuItemController;
import com.test.hyxc.chat.entity.Event;
import com.test.hyxc.chat.view.ConversationListView;
import com.test.hyxc.chat.view.MenuItemView;
    ...
    public void onEvent(MessageEvent event) {
        ...
        if (msg.getTargetType() == ConversationType.group) {
            ...
            if (conv != null && mConvListController != null) {
                if (msg.isAtMe()) {
                    AppContext.isAtMe.put(groupId, true);
                    mConvListController.getAdapter().putAtConv(conv, msg.getId());
                }
                if (msg.isAtAll()) {
                    AppContext.isAtall.put(groupId, true);
