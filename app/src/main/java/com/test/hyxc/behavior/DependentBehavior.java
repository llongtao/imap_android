package com.test.hyxc.behavior;
...
public class DependentBehavior extends CoordinatorLayout.Behavior<Toolbar> {
    ...
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, Toolbar toolbar, View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
        startOffset = 0;
        endOffset = context.getResources().getDimensionPixelOffset(R.dimen.testbehavior) - toolbar.getHeight();
        offset += dyConsumed;
