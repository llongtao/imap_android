...
public class NetUtils {
     ...
     * @param myNetCall
     */
    public  void postDataAsynToNetToken(String url,String token, Map<String,String> bodyParams, final MyNetCall myNetCall) throws Exception {
     ...
     * @param myNetCall
     */
    public  void postDataAsynToNet(String url, Map<String,String> bodyParams, final MyNetCall myNetCall) throws Exception {
        //1构造RequestBody
        RequestBody body=setRequestBody(bodyParams);
        //2 构造Request
        Request.Builder requestBuilder = new Request.Builder();
        Request request = requestBuilder
                .addHeader("Authorization-Device","android")
                .addHeader("Authorization-Version","1.0")
                .addHeader("Authorization-Timestamp",String.valueOf(System.currentTimeMillis()))
                .post(body).url(url).build();
        //3 将Request封装为Call
        Call call = mOkHttpClient.newCall(request);
        //4 执行Call
